...
export default function UpdateProduct({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params);
    const form = useForm<z.infer<typeof ProductSchema>>({
        ...
        defaultValues: {
            ...
            itemType: "Ranga",
            quality: "Regular",
            itemNameInvoice: "Green Raisins A",
            hsnCode: "42004338",
            brand: "Brand A",
            gst: "123456Gr453",
    ...
    return (
        <>
            <DashboardStrip title="Update Product" />
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col space-y-1 w-1/4 px-2">
                                    ...
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        ...
                                        <SelectContent>
                                            <SelectItem value="Green Raisins A">Green Raisins A</SelectItem>
                                            <SelectItem value="Green Raisins B">Green Raisins B</SelectItem>
                                            <SelectItem value="Green Raisins C">Green Raisins C</SelectItem>
                                        </SelectContent>
                                    </Select>
                                    <FormMessage />
                                </FormItem>
