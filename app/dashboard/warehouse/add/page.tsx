...
export default function AddWarehousePage() {
    ...
    return (
        <>
            <DashboardStrip title="Add Warehouse" />
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-wrap space-y-4.5">
                        ...
                        <div className="w-full flex flex-row gap-x-2.5 justify-end">
                            ...
                            <Button variant="outline" className="bg-blue-500 text-white hover:bg-blue-600 hover:text-white cursor-pointer" type="submit">Submit</Button>
                        </div>
                    </form>
                </Form>
            </Card>
