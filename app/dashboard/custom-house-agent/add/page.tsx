...
export default function CHAPage() {
    ...
    return (
        <>
            <DashboardStrip title="Add Custom House Agent" />
                        ...
                        <FormField
                            ...
                            render={({ field, fieldState }) => (
                                <MultiSelect
                                    field={{ ...field }}
                                    data={data}
                                    placeholder="Select Port Cater"
                                    label="Which Port Cater"
                                    required={true}
                        ...
                        <FormField
                            ...
                            render={({ field, fieldState }) => (
                                <MultiSelect
                                    field={{ ...field }}
                                    data={data}
                                    placeholder="Select Items Handled"
                                    label="Which Items Handled"
                                    required={true}
                                    error={!!fieldState.error}
                                    errorMessage={fieldState.error?.message}
                                />
